...
$categoryFormHandler = new CategoryFormHandler($pdo);
...
<head>
    ...
    <link rel="stylesheet" href="/listing/assets/css/style.css">
</head>
<body>
    ...
    <script src="/listing/assets/js/category-page.js"></script>
</body>
</html>
